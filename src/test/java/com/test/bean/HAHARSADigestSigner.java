...
/**
 * @description: HAHARSADigestSigner
 * @date: 2022/9/8 10:49
 * @author: fanqie
 */
public class HAHARSADigestSigner implements Signer
{
            ...
            int     length)
    {
        ...
        System.out.println("给签名类设置摘要" + digest.getDigestSize());
    }
