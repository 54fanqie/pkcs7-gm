...
/**
 * @description: HAHASM3Digest
 * @date: 2022/9/16 14:25
 * @author: fanqie
 */

public class HAHASM3Digest extends GeneralDigest {
     ...
     * message digest.
     */
    public HAHASM3Digest(HAHASM3Digest t) {
        super(t);

        copyIn(t);
    }

    private void copyIn(HAHASM3Digest t) {
     ...
     * @throws  if the <b>other</b> parameter is in some other way invalid.
     */
    @Override
    public void reset(Memoable other) {


        HAHASM3Digest d = (HAHASM3Digest) other;
    ...
    public int doFinal(byte[] out,
        ...
        reset();
        System.out.println("HAHASM3Digest -> doFinal计算最后摘要值 ：" + HexUtil.byteToHex(out));
        return DIGEST_LENGTH;
    }
