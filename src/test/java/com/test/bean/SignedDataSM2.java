...
public class SignedDataSM2 extends ASN1Object {
    ...
    public SignedDataSM2(ASN1Set paramASN1Set1, ContentInfo paramContentInfo, ASN1Set paramASN1Set2, ASN1Set paramASN1Set3, ASN1Set paramASN1Set4) {
    ...
    private SignedDataSM2(ASN1Sequence paramASN1Sequence) {
    ...
    public static SignedDataSM2 getInstance(Object paramObject) {
        if (paramObject instanceof SignedData)
            return ((SignedDataSM2) paramObject);
        if (paramObject != null)
            return new SignedDataSM2(ASN1Sequence.getInstance(paramObject));
        return null;
    }
