...
/**
 * @description: SwSM2Signer
 * @date: 2022/9/9 14:33
 * @author: fanqie
 */
public class HAHASM2Signer implements Signer, ECConstants
{
    ...
    public HAHASM2Signer()
    {
        this(StandardDSAEncoding.INSTANCE, new SM3Digest());
    }

    public HAHASM2Signer(Digest digest)
    {
        this(StandardDSAEncoding.INSTANCE, digest);
    }

    public HAHASM2Signer(DSAEncoding encoding)
    {
        this.encoding = encoding;
        this.digest = new SM3Digest();
    }

    public HAHASM2Signer(DSAEncoding encoding, Digest digest)
    {
        this.encoding = encoding;
        this.digest = digest;
    }
    ...
    {
        System.out.println("HAHASM2Signer -> 设置数据：" + HexUtil.byteToHex(in));
    ...
    public boolean verifySignature(byte[] signature)
    {
        try
        {
            System.out.println("签名值: " + HexUtil.byteToHex(signature));
        ...
        {
            throw  new RuntimeException("verifySignature 中  ecParams  为空   " + e);
        }
    ...
    private boolean verifySignature(BigInteger r, BigInteger s)
    {
        ...
        // B3
        byte[] eHash = digestDoFinal();
        System.out.println("签名值: " + HexUtil.byteToHex(eHash));
    ...
    public byte[] digestDoFinal()
    {
        ...
        System.out.println("HAHASM2Signer  -> digestDoFinal计算摘要: " + HexUtil.byteToHex(result));
        reset();
        return result;
    }
